...
CREATE TABLE `backup` (
  ...
  CONSTRAINT `backup_ibfk_1` FOREIGN KEY (`responsavel`) REFERENCES `colaborador` (`id_colaborador`)
...
INSERT INTO `backup` VALUES (1,'2025-09-02 20:49:20','2025-10-02',1),(2,'2025-09-02 20:49:20','2025-10-02',2),(3,'2025-09-02 20:49:20','2025-10-02',3),(4,'2025-09-02 20:49:20','2025-10-02',4),(5,'2025-09-02 20:49:20','2025-10-02',5);
...
CREATE TABLE `chamado` (
  ...
  KEY `tecnico_designado` (`tecnico_designado`),
  CONSTRAINT `chamado_ibfk_1` FOREIGN KEY (`tecnico_designado`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chamado` VALUES (1,'TI','Alta','Aberto',3),(2,'Financeiro','Média','Em Andamento',3),(3,'RH','Baixa','Resolvido',1),(4,'TI','Urgente','Aberto',5),(5,'Segurança','Alta','Fechado',4);
...
CREATE TABLE `colaborador` (
  ...
  CONSTRAINT `colaborador_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `colaborador` VALUES (1,1,'João da Silva','Analista de Sistemas','TI','Ativo','joao@bitsecure.com','101','Java, SQL, Redes'),(2,2,'Maria Souza','Gestora de Projetos','PMO','Ativo','maria@bitsecure.com','102','Scrum, Kanban'),(3,3,'Carlos Oliveira','Técnico de Suporte','Suporte','Home Office','carlos@bitsecure.com','103','Linux, Redes'),(4,4,'Ana Pereira','Auditoria Interna','Auditoria','Férias','ana@bitsecure.com','104','Compliance, Segurança'),(5,5,'Lucas Santos','Desenvolvedor Backend','TI','Ativo','lucas@bitsecure.com','105','Python, API, Docker');
...
--
-- Table structure for table `logatividade`
--
...
CREATE TABLE `logatividade` (
  ...
  CONSTRAINT `logatividade_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `logatividade`
--

LOCK TABLES `logatividade` WRITE;
/*!40000 ALTER TABLE `logatividade` DISABLE KEYS */;
INSERT INTO `logatividade` VALUES (1,1,'2025-09-02 20:49:15','Login','Usuário logado com sucesso'),(2,2,'2025-09-02 20:49:15','Criar Projeto','Projeto Dashboard Financeiro criado'),(3,3,'2025-09-02 20:49:15','Abrir Chamado','Chamado para TI registrado'),(4,4,'2025-09-02 20:49:15','Gerar Relatório','Relatório de auditoria salvo'),(5,5,'2025-09-02 20:49:15','Editar Tarefa','Tarefa de backend atualizada');
/*!40000 ALTER TABLE `logatividade` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mensagem` (
  ...
  CONSTRAINT `mensagem_ibfk_1` FOREIGN KEY (`remetente`) REFERENCES `colaborador` (`id_colaborador`),
  CONSTRAINT `mensagem_ibfk_2` FOREIGN KEY (`destinatario`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mensagem` VALUES (1,1,2,NULL,'Preciso do status do projeto','2025-09-02 20:49:07'),(2,2,1,NULL,'O projeto está em andamento','2025-09-02 20:49:07'),(3,3,4,NULL,'Incidente resolvido no servidor','2025-09-02 20:49:07'),(4,4,5,NULL,'Favor revisar relatório de auditoria','2025-09-02 20:49:07'),(5,5,2,NULL,'Atualizei o backend do sistema','2025-09-02 20:49:07');
...
DROP TABLE IF EXISTS `perfilacesso`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `perfilacesso` VALUES (1,'Administrador','Acesso total ao sistema'),(2,'Gestor','Gerencia equipe e projetos'),(3,'Técnico','Executa chamados e tarefas técnicas'),(4,'Colaborador','Acessa tarefas e projetos designados'),(5,'Auditor','Somente visualiza relatórios e logs');
...
CREATE TABLE `permissao` (
  ...
  `nivel` enum('Total','Limitado','Visualizacao','Criar/Editar','Atribuídos','Próprias','Negado') NOT NULL,
  PRIMARY KEY (`id_permissao`),
  KEY `id_perfil` (`id_perfil`),
  CONSTRAINT `permissao_ibfk_1` FOREIGN KEY (`id_perfil`) REFERENCES `perfilacesso` (`id_perfil`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `permissao` VALUES (1,1,'Projetos','Total'),(2,2,'Tarefas','Criar/Editar'),(3,3,'Chamados','Criar/Editar'),(4,4,'Relatórios','Visualizacao'),(5,5,'Logs','Visualizacao');
...
CREATE TABLE `projeto` (
  ...
  KEY `responsavel` (`responsavel`),
  CONSTRAINT `projeto_ibfk_1` FOREIGN KEY (`responsavel`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `projeto` VALUES (1,'Sistema de Chamados','Software','Em Andamento',45,2,'Desenvolvimento do sistema de chamados internos'),(2,'Firewall Corporativo','Security','No Prazo',80,1,'Implantação de firewall e monitoramento'),(3,'Dashboard Financeiro','Software','Atrasado',30,2,'Criação de dashboards de indicadores financeiros'),(4,'Pentest Aplicativo X','Security','Em Andamento',55,4,'Teste de segurança em aplicativo interno'),(5,'Portal do Colaborador','Software','No Prazo',70,5,'Plataforma para acesso de colaboradores');
/*!40000 ALTER TABLE `projeto` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `projetoequipe`
--

DROP TABLE IF EXISTS `projetoequipe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `projetoequipe` (
  ...
  CONSTRAINT `projetoequipe_ibfk_1` FOREIGN KEY (`id_projeto`) REFERENCES `projeto` (`id_projeto`),
  CONSTRAINT `projetoequipe_ibfk_2` FOREIGN KEY (`id_colaborador`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `projetoequipe`
--

LOCK TABLES `projetoequipe` WRITE;
/*!40000 ALTER TABLE `projetoequipe` DISABLE KEYS */;
INSERT INTO `projetoequipe` VALUES (1,1),(2,1),(4,1),(1,2),(3,2),(5,2),(1,3),(5,3),(2,4),(4,4),(3,5),(4,5),(5,5);
/*!40000 ALTER TABLE `projetoequipe` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `registroponto` (
  ...
  KEY `id_colaborador` (`id_colaborador`),
  CONSTRAINT `registroponto_ibfk_1` FOREIGN KEY (`id_colaborador`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `registroponto` VALUES (1,1,'2025-09-02 08:00:00','2025-09-02 17:00:00'),(2,2,'2025-09-02 09:00:00','2025-09-02 18:00:00'),(3,3,'2025-09-02 08:30:00','2025-09-02 17:30:00'),(4,4,'2025-09-02 07:45:00','2025-09-02 16:45:00'),(5,5,'2025-09-02 08:15:00','2025-09-02 17:15:00');
...
CREATE TABLE `relatorio` (
  ...
  `tipo` enum('Auditoria','Incidente','Pentest','Projeto') NOT NULL,
  ...
  CONSTRAINT `relatorio_ibfk_1` FOREIGN KEY (`autor`) REFERENCES `colaborador` (`id_colaborador`),
  CONSTRAINT `relatorio_ibfk_2` FOREIGN KEY (`id_projeto`) REFERENCES `projeto` (`id_projeto`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `relatorio` VALUES (1,'Auditoria',4,2,'2025-09-02 17:48:59','Relatório de auditoria de segurança do firewall'),(2,'Incidente',3,1,'2025-09-02 17:48:59','Falha em servidor interno resolvida'),(3,'Pentest',1,4,'2025-09-02 17:48:59','Resultados do teste de penetração no sistema X'),(4,'Projeto',2,3,'2025-09-02 17:48:59','Status do projeto financeiro atrasado'),(5,'Auditoria',4,5,'2025-09-02 17:48:59','Verificação de compliance no portal do colaborador');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-09-02 20:36:05',NULL),('diagnostics.include_raw','OFF','2025-09-02 20:36:05',NULL),('ps_thread_trx_info.max_length','65535','2025-09-02 20:36:05',NULL),('statement_performance_analyzer.limit','100','2025-09-02 20:36:05',NULL),('statement_performance_analyzer.view',NULL,'2025-09-02 20:36:05',NULL),('statement_truncate_len','64','2025-09-02 20:36:05',NULL);
...
CREATE TABLE `tarefa` (
  ...
  CONSTRAINT `tarefa_ibfk_2` FOREIGN KEY (`responsavel`) REFERENCES `colaborador` (`id_colaborador`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tarefa` VALUES (1,'Configurar servidor',1,'2025-09-10','Alta','To-Do',1),(2,'Criar documentação',1,'2025-09-15','Média','Planejado',2),(3,'Configurar firewall',2,'2025-09-20','Alta','Em Andamento',4),(4,'Testar API financeira',3,'2025-09-08','Urgente','Doing',5),(5,'Revisar pentest',4,'2025-09-25','Média','Pendente',4);
...
INSERT INTO `usuario` VALUES (1,'joao.silva','55a5e9e78207b4df8699d60886fa070079463547b095d1a05bc719bb4e6cd251','pt-BR','America/Sao_Paulo',0,0),(2,'maria.souza','6b08d780140e292a4af8ba3f2333fc1357091442d7e807c6cad92e8dcd0240b7','pt-BR','America/Sao_Paulo',0,0),(3,'carlos.oliveira','b578dc5fcbfabbc7e96400601d0858c951f04929faef033bbbc117ab935c6ae9','pt-BR','America/Sao_Paulo',0,0),(4,'ana.pereira','4dbd4e8fdfeeb99bb9f59a0d018efd61199cb09af49a8c2d733648a583163d43','pt-BR','America/Sao_Paulo',0,0),(5,'lucas.santos','70213e9ef0abf2ed32575dd9425e339907473d4d0635a518b6b37a35ca5b0c77','pt-BR','America/Sao_Paulo',0,0);
...
-- Dump completed on 2025-09-02 18:35:34
